...
resource "ncloud_route_table_association" "pri_svc_association" {
  route_table_no = ncloud_route_table.private_route_table.id
  subnet_no      = ncloud_subnet.pri_svc_subnet.id
}

resource "ncloud_route_table_association" "pri_db_association" {
  route_table_no = ncloud_route_table.private_route_table.id
  subnet_no      = ncloud_subnet.pri_db_subnet.id
}